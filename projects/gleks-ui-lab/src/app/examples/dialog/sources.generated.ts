...
export const DIALOG_EXAMPLE_SOURCES: ReadonlyMap<unknown, ExampleSource> = new Map<
  unknown,
  ExampleSource
>([
  [
  ...
  [
    ...
    {
      html: '<div class="example">\n  <gog-button (gogClick)="open()">Open the first one</gog-button>\n</div>',
