...
**Latest release: 21.7.1 (2026-08-29), on npm and tagged.** `projects/gleks/ui/CHANGELOG.md` is the authority and
...
| **21.7.2** | **in progress**           | More feedback-triage defects — see `docs/feedback-triage.md`. Landed so far: the multiselect `+N` overflow chip's baseline alignment (Q3), fixed in the library and `ui-showcase`. Q1 (`gog-menu` over the lab's footer) was investigated and closed — not reproduced at desktop width against the published 21.7.1.                                                                                                                                                                                                                                                                                                                                                                        |
